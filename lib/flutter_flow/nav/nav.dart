...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          asyncParams: {
            'subscription':
                getDoc(['subscriptions'], SubscriptionsRecord.fromSnapshot),
          },
          builder: (context, params) => EditSubscriptionWidget(
            subscription: params.getParam(
              'subscription',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          name: 'addDefaultSubscription',
          path: '/addDefaultSubscription',
          builder: (context, params) => AddDefaultSubscriptionWidget(),
        ),
        FFRoute(
          name: 'editLanguage',
          path: '/editLanguage',
          builder: (context, params) => EditLanguageWidget(),
        ),
        FFRoute(
          name: 'editCurrency',
          path: '/editCurrency',
          builder: (context, params) => EditCurrencyWidget(),
        ),
        FFRoute(
          name: 'manageCards',
          path: '/manageCards',
          builder: (context, params) => ManageCardsWidget(),
        )
